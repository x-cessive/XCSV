...
| vault | `50-xcsv-guard\build-and-release.md` | If extDB3 is ever revisited |
...
| vault | `60-infrastructure\headless-client.md` | 60-infrastructure â€” Headless Client (UNRESOLVED) |
...
| vault | `60-infrastructure\headless-client.md` | 3.5 Confirmed working on the server side |
...
| vault | `AGENTS.md` | AGENTS.md â€” ARMA3_EXILE_CODEX (XCSV estate) |
| vault | `AGENTS.md` | Ground truth is in FOUR places â€” check ALL of them before starting |
| vault | `AGENTS.md` | Every live change must leave memory behind |
| vault | `AGENTS.md` | Estate separation (hard rule) |
| vault | `AGENTS.md` | Working rules (abridged from CLAUDE.md â€” read it for the why) |
