...
| **XM8 apps** | territory browser first (removes the most support burden), then a real scoreboard (establishes the `Rsc` slide pattern). Sixteen more catalogued in [XM8 Apps](XM8-Apps) |
