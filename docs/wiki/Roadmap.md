...
title: Roadmap
heading: Roadmap
blurb: Durable planning direction and issue routing, not execution/runtime proof.
order: 13
source: Roadmap.md
generated: true
...
For execution state, read the linked GitHub issues and pull requests. For component/source evidence, read [System Components](System-Components.html). For freshness, read `registry/current-state.json` and compare observations to the live source when the claim matters.
...
- [Roadmap History](Roadmap-History.html)
