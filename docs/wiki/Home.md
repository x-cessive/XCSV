...
source: Home.md
generated: true
source_authority: wiki/Home.md
---

<!-- GENERATED FROM wiki/Home.md BY tools/build-docs.ps1. DO NOT EDIT docs/wiki BY HAND. -->
...
> **AI / AGENT START HERE:** begin at the root `AI-START-HERE.md`, then read [AI Start Here](AI-Start-Here.html), [Repository Identity & Freshness](Repository-Identity-and-Freshness.html), and [AI Provenance & Doc Sync](AI-Provenance-and-Doc-Sync.html) before interpreting roadmap state or creating commits.
...
| need | page |
|---|---|
| architecture and evidence boundaries | [Architecture](Architecture.html) |
| component inventory and source-wiring evidence | [System Components](System-Components.html) |
| repository ownership and local path notes | [Repositories](Repositories.html) |
| operations and recovery | [Runbook](Runbook.html) |
| XM8 app source/status boundaries | [XM8 Apps](XM8-Apps.html) |
| map authoring and static object custody | [Custom Map Editing](Custom-Map-Editing.html) |
| drone and counter-UAS design boundary | [Drone & Counter-UAS](Drone-and-Counter-UAS.html) |
| GUARD design programme | [GUARD Development Plan](XCSV-GUARD-Development-Plan.html) |
| roadmap and future work | [Roadmap](Roadmap.html) |
| historical lessons | [Lessons](Lessons.html) |
