...
layout: wiki
section: docs
title: AI Provenance & Doc Sync
heading: AI Provenance & Doc Sync
...
This policy is a mandatory companion to [AI Start Here](AI-Start-Here.html). It governs two failure classes that the roadmap reconciliation contract alone cannot solve:
